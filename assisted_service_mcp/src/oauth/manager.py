...
class OAuthManager:
    ...
    def get_stored_access_token(self, token_id: str) -> Optional[str]:
        ...
        Returns:
            Access token if found and valid, None otherwise
        """
        return self.get_access_token_by_id(token_id)
...
def get_oauth_access_token_from_mcp(mcp: Any) -> Optional[str]:
    ...
    if oauth_token_id:
        return oauth_manager.get_stored_access_token(oauth_token_id)
