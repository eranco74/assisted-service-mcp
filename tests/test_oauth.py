...
class TestOAuthManager:
    ...
    @patch("requests.post")
    async def test_exchange_code_for_token_success(self, mock_post: MagicMock) -> None:
...
class TestOAuthIntegration:
    ...
    def test_get_oauth_access_token_from_mcp_with_token_id(self) -> None:
        ...
        with (
            patch("assisted_service_mcp.src.oauth.settings.OAUTH_ENABLED", True),
            patch(
                "assisted_service_mcp.src.oauth.oauth_manager.get_stored_access_token"
            ) as mock_get_token,
        ):
            mock_get_token.return_value = "stored_access_token"
